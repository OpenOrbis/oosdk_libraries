...
Ported to OOSDK for PS4 by CrazyVoid on 2/29/2020

## Notes 
	- please use the oosdk_build.bat to build and install libmap to oosdk.
	- to link with libmap, open your build.bat and add to libraries list -lmap
	
## OOSDK Todo
	- Modify the sample to compile for oosdk (SAMPLE DOES NOT COMPILE FOR PS4 ATM)

## Original Source : https://github.com/rxi/map
